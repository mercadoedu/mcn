...
# Collecting mocked stopwords data ####
mo_stopwords_list <- get_stopwords(con = mo_con, tbl_name = sn$mo_tbl_name_sw)

# Testing the preparation of mocked matching data ####
test_that("prep_matching_data() works with mocked data source", {
...
# Testing the preparation of mocked quarantine data ####
test_that("prep_quarantine_data() works with mocked bucket folder", {
